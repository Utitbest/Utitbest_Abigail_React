...
import './About.css'
import { about, play_icon } from '../../assets'
    ...
    <div className='about' name="about">
        ...
        <div className="about-right">
            ...
            <p>With a focus on innovation, hands-on learning, and personalized 
                mentorship, our programs prepare aspiring edcators to make a
            ...
            <p>Whether you aspire to become a teacher, adminstrator,
                ...
                offers the perfect pathway to achieve your goals an unlock your
